...
<div class="letter-box" style="border:none; padding:0; margin-top:0;">
    <div class="company-head" style="margin-bottom:10px;">
        ...
        <div style="margin-top:4px; font-weight:700; font-size:16px;">নিয়োগ পত্র(Appointment Lettrer)</div>
    </div>

    <table class="letter-grid" style="margin-bottom:12px;">
        <tr>
            <td class="k">শ্রমিকের নাম</td><td class="s">:</td><td class="v">{{ $employee->name ?? 'N/A' }}</td>
        ...
        <tr>
            ...
            <td class="k">পদবীঃ</td><td class="s">:</td><td class="v">{{ optional($employee->designation)->name ?? 'N/A' }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="k">কাজের ধরন</td><td class="s">:</td><td class="v">{{ $jobType ?: 'Worker' }}</td>
    ...
    <p style="font-size:12px; line-height:1.7; text-align:justify; margin-bottom:10px;">
        আপনার আবেদন, সাক্ষাৎকার এবং যোগ্যতা যাচাইয়ের পরিপ্রেক্ষিতে আপনাকে {{ $joiningDateShort }} ইং তারিখ হইতে {{ optional($employee->designation)->name ?? 'N/A' }} পদে {{ $gradeName ?: ($employee->grade_lavel ?: 'N/A') }} নং গ্রেডে নম্নলিখিত শর্তসাপেক্ষে নিয়োগ প্রদান করিতেছি। নিয়োগ প্রাপ্তির তিন মাস প্রাথমিক পর্যায় হিসাবে গণ্য হবে। যদি দেখা যায় যে নিয়োগ প্রাপ্তির তিন মাস প্রাথমিক পর্যায়ে আপনি সম্পূর্ণ যোগ্যতা অর্জন করিতে পারেন নাই, তখন ইহা আর ও তিন মাস পর্যন্ত বর্ধিত করা হবে। এই সময়ের পর আপনাকে স্থায়ী শ্রমিক হিসাবে গণ্য করা হবে এবং ইহার জন্য কোন প্রকার চিঠি দেওয়া হবে না।
    </p>
    ...
    <div style="font-size:12px; line-height:1.7;">
        ...
        <table class="salary-table" style="margin-bottom:10px;">
            <tbody>
                <tr><td>ক। মাসিক মূল মঞ্জুরী (Monthly Basic Wages)</td><td style="width:70px;">টাকা</td><td style="width:140px;">{{ number_format($basicSalary, 2) }} /=</td></tr>
                <tr><td>খ। মাসিক বাড়ী ভাড়া ভাতা (Monthly House Rent 50% of Basic pay)</td><td>টাকা</td><td>{{ number_format($houseRent, 2) }} /=</td></tr>
                <tr><td>গ। মাসিক চিকিৎসা ভাতা (Monthly Medical Allowance)</td><td>টাকা</td><td>{{ number_format($medicalAllowance, 2) }} /=</td></tr>
                <tr><td>ঘ। মাসিক যাতায়াত ভাতা (Monthly Transport Allowance)</td><td>টাকা</td><td>{{ number_format($transportAllowance, 2) }} /=</td></tr>
                <tr><td>ঙ। মাসিক খাদ্য ভাতা (Monthly Fooding Allowance)</td><td>টাকা</td><td>{{ number_format($foodAllowance, 2) }} /=</td></tr>
                <tr><td><strong>মাসিক সর্বমোট টাকা (Monthly Gross Amount)</strong></td><td>টাকা</td><td><strong>{{ number_format($grossSalary, 2) }} /=</strong></td></tr>
                <tr><td>প্রতি ঘন্টায় ও.টির হার(Over Time)</td><td>টাকা</td><td>{{ number_format($otRate, 2) }} /=</td></tr>
            </tbody>
        </table>
        ...
        <p style="margin:0 0 6px;">বঙ্গ নীটওয়্যার লিমিটেড এর শ্রমিক/কর্মচারীদের চাকুরীর সাধারন নিয়মাবলী ও সুবিধাদি নিম্নে উল্লেখ করা হলঃ</p>
