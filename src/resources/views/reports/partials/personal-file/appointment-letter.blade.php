...
<div class="letter-box" style="border:none; padding:0; margin-top:0;">
    <div class="company-head" style="margin-bottom:10px;">
        <h3 style="margin:0; font-size:22px;">{{ $general->title ?? '' }}</h3>
    ...
    <div style="font-size:12px; line-height:1.7;">
        ...
        <table class="salary-table" style="margin-bottom:10px;">
            <tbody>
                <tr><td>ক। মাসিক মূল মঞ্জুরী (Monthly Basic Wages)</td><td style="width:70px;">টাকা</td><td style="width:140px;">{{ number_format($basic, 2) }} /=</td></tr>
                <tr><td>খ। মাসিক বাড়ী ভাড়া ভাতা (Monthly House Rent 50% of Basic pay)</td><td>টাকা</td><td>{{ number_format($house, 2) }} /=</td></tr>
                <tr><td>গ। মাসিক চিকিৎসা ভাতা (Monthly Medical Allowance)</td><td>টাকা</td><td>{{ number_format($medical, 2) }} /=</td></tr>
                <tr><td>ঘ। মাসিক যাতায়াত ভাতা (Monthly Transport Allowance)</td><td>টাকা</td><td>{{ number_format($transport, 2) }} /=</td></tr>
                <tr style="border-bottom: 1px solid rgba(0, 0, 0, 0.589)"><td>ঙ। মাসিক খাদ্য ভাতা (Monthly Fooding Allowance)</td><td>টাকা</td><td>{{ number_format($food, 2) }} /=</td></tr>
                <tr><td><strong>মাসিক সর্বমোট টাকা (Monthly Gross Amount)</strong></td><td>টাকা</td><td><strong>{{ number_format($gross, 2) }} /=</strong></td></tr>
