...
<div class="row">
    ...
    @endif
    <div class="col-md-4 mb-2"><label class="mb-1">Name</label><input type="text" name="name" value="{{ old('name', $employee->name) }}" class="form-control form-control-sm" required></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Name Bangla</label><input type="text" name="bn_name" value="{{ old('bn_name', $employee->bn_name) }}" class="form-control form-control-sm"></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Employee ID</label><input type="text" name="employee_id" value="{{ old('employee_id', $employee->employee_id) }}" class="form-control form-control-sm" required></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Join Date</label><input type="date" name="joining_date" value="{{ old('joining_date', optional($employee->joining_date)->format('Y-m-d')) }}" class="form-control form-control-sm"></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Classification</label><select name="employee_type" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['classifications'] as $row)<option value="{{ $row->id }}" @selected((string) old('employee_type', $employee->employee_type) === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Department</label><select name="department_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['departments'] as $row)<option value="{{ $row->id }}" @selected((string) old('department_id', $employee->department_id) === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Section</label><select name="section_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['sections'] as $row)<option value="{{ $row->id }}" @selected((string) old('section_id', $employee->section_id) === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Sub-Section</label><select name="sub_section_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['subSections'] as $row)<option value="{{ $row->id }}" @selected((string) $selectedSubSection === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Block/Line</label><select name="line_number" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['lines'] as $row)<option value="{{ $row->id }}" @selected((string) old('line_number', $employee->line_number) === (string) $row->id)>{{ trim(($row->name ?? '') . (filled($row->slug ?? null) ? ' - ' . $row->slug : '')) }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Designation</label><select name="designation_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['designations'] as $row)<option value="{{ $row->id }}" @selected((string) old('designation_id', $employee->designation_id) === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Working Place</label><select name="working_place_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['workingPlaces'] as $row)<option value="{{ $row->id }}" @selected((string) $selectedWorkingPlace === (string) $row->id)>{{ $row->name }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Shift</label><select name="shift_id" class="form-control form-control-sm"><option value="">Select</option>@foreach($options['shifts'] as $row)<option value="{{ $row->id }}" @selected((string) old('shift_id', $employee->shift_id) === (string) $row->id)>{{ $row->name_of_shift }}</option>@endforeach</select></div>
    <div class="col-md-4 mb-2">
    ...
    <div class="col-md-4 mb-2"><label class="mb-1">Personal Contact</label><input type="text" name="mobile" value="{{ old('mobile', $employee->mobile) }}" class="form-control form-control-sm"></div>
    <div class="col-md-4 mb-2"><label class="mb-1">Emergency Contact</label><input type="text" name="emergency_mobile" value="{{ old('emergency_mobile', $employee->emergency_mobile) }}" class="form-control form-control-sm"></div>
    <div class="col-md-4 mb-2">
