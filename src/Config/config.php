...
return [
    ...
    'entities' => [
        ...
        'bonus-policies' => [
            ...
            'index_fields' => ['name', 'month_from', 'month_to', 'salary_basis', 'amount_type', 'amount', 'status'],
            'fields' => [
                ...
                'month_from' => ['label' => 'Month Range From', 'type' => 'number', 'rules' => 'nullable|integer|min:0', 'min' => '0'],
                'month_to' => ['label' => 'Month Range To', 'type' => 'number', 'rules' => 'nullable|integer|min:0', 'min' => '0'],
        ...
        'salary-keys' => [
            ...
            'search' => ['name'],
            'defaults' => ['status' => 'active'],
            'index_fields' => ['medical', 'lunch', 'transport', 'status'],
            'fields' => [
